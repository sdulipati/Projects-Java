...
public class BankRecords extends Client {
	...
	private static BankRecords robjs[] = new BankRecords[600]; 
	...
	public void readData() throws FileNotFoundException, IOException{
		BufferedReader br = null;
	     ...
	     if(br != null) {
	       ...
	       // Printing the total number of records in csv file
	       System.out.println("Total Cutomer Records in bank-Detail.csv is "+ robjs.length);
	     }
	     else{
